...
function calc() {
  ...
  getDynamicInfo('#age'); // fetch('https://jsonplaceholder.typicode.com/posts', {
  //     method: "POST",
...
function slider({
  ...
  const slides = document.querySelectorAll(slide),
        ...
        width = window.getComputedStyle(slidesWrapper).width; // version 2:
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_7__["default"])('.timer', '2021-10-10');
